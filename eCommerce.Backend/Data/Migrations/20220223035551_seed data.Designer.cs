...
namespace eCommerce.Backend.Data.Migrations
{
    ...
    [Migration("20220223035551_seed data")]
            ...
            modelBuilder.Entity("eCommerce.Backend.Models.Brand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 2, 23, 10, 55, 51, 429, DateTimeKind.Local).AddTicks(6600),
                            Image = "",
                            IsShowOnHome = true,
                            Name = "Andora",
                            SeoAlias = "Andora",
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2022, 2, 23, 10, 55, 51, 429, DateTimeKind.Local).AddTicks(6620),
                            Image = "",
                            IsShowOnHome = true,
                            Name = "Apple",
                            SeoAlias = "Apple",
                        ...
                        {
                            Id = 6,
                            DateCreated = new DateTime(2022, 2, 23, 10, 55, 51, 429, DateTimeKind.Local).AddTicks(6630),
                            Image = "",
                            IsShowOnHome = true,
                            Name = "Filco",
                            SeoAlias = "Filco",
                        ...
                        {
                            Id = 14,
                            DateCreated = new DateTime(2022, 2, 23, 10, 55, 51, 429, DateTimeKind.Local).AddTicks(6640),
                            Image = "",
                            IsShowOnHome = true,
                            Name = "Tucano",
                            SeoAlias = "Tucano",
            ...
            modelBuilder.Entity("eCommerce.Backend.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2022, 2, 23, 10, 55, 51, 429, DateTimeKind.Local).AddTicks(6840),
                            IsShowOnHome = true,
                        ...
                        {
                            Id = 2,
                            DateCreated = new DateTime(2022, 2, 23, 10, 55, 51, 429, DateTimeKind.Local).AddTicks(6850),
                            IsShowOnHome = true,
                        ...
                        {
                            Id = 9,
                            DateCreated = new DateTime(2022, 2, 23, 10, 55, 51, 429, DateTimeKind.Local).AddTicks(6860),
                            IsShowOnHome = true,
                            Name = "Ipad Case",
                            ParentId = 3,
                            SeoAlias = "ipad-case",
            ...
            modelBuilder.Entity("eCommerce.Backend.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BrandId = 7,
                            DateCreated = new DateTime(2022, 2, 23, 10, 55, 51, 429, DateTimeKind.Local).AddTicks(6890),
                            DecreasedPrice = 0m,
                        ...
                        new
                        {
                            Id = 5,
                            BrandId = 15,
                            DateCreated = new DateTime(2022, 2, 23, 10, 55, 51, 429, DateTimeKind.Local).AddTicks(6900),
                            DecreasedPrice = 0m,
                            Description = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
                            Details = "Lorem Ipsum is simply dummy text of the printing and typesetting industry.",
                            IsFeatured = false,
